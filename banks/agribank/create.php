 ...
 <div class="grid gap-5 md:grid-cols-1">
     ...
     <div class="grid gap-5 md:grid-cols-3">
         ...
         <?php include $_SERVER['DOCUMENT_ROOT'].'/select-bank-argi.php'; ?>
         <div class="">
         ...
         <div class="">
             ...
             <input id="time_bill" class="form-input w-full" type="text" value="<?= date('d-m-Y G:i:s') ?>" placeholder="Ví dụ: <?= date('d-m-Y G:i:s') ?>">
         </div>
         <div class="">
         ...
         <div class="">
             ...
             <input id="magiaodich" class="form-input w-full" type="text" value="<?= rand(00000, 999999) ?>">
         </div>
         <div>
