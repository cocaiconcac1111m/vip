 ...
 <div class="grid gap-5 md:grid-cols-1">
     ...
     <div class="grid gap-5 md:grid-cols-3">
         ...
         <div class="">
             ...
             <input id="time_bill" class="form-input w-full" type="text" value="<?= date('d/m/Y') ?> <?= date('G:i:s') ?>" placeholder="">
         </div>
         <div class="">
         ...
         <div class="">
             ...
             <input id="magiaodich" class="form-input w-full" type="text" value="<?= generateRandomNumber() ?>">
         </div>
         <div>

             <label class="block text-sm mb-2" for="default">Chỉnh dung lượng pin</label>
             <div x-data="{ modalOpen: false }">
                 <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white" @click.prevent="modalOpen = true" aria-controls="basic-modal">Chỉnh dung lượng</button>
                 <!-- Modal backdrop -->
         ...
         <div>
             <button onclick="taoBill('primary')" class="mb-3 btn bg-emerald-500 hover:bg-emerald-600 w-full text-white">Tạo bill (<?= number_format($tiengoc) ?>)</button>
