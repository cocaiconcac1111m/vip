   ...
   <div class="grid gap-5 md:grid-cols-1">
                                    ...
                                    <div class="grid gap-5 md:grid-cols-3">
                                        <div class="">
                                         ...
                                         <div class="">
                                            <label class="block text-sm mb-2" for="default">Số tiền giao dịch</label>
                                            <input value="100000"  id="amount" class="form-input w-full" type="number" placeholder="Ví dụ: 100000">
                                        </div>
                                      
                                          <div class="">
                                            <label class="block text-sm mb-2" for="default">Loại giao dịch</label>
                                           <select id="type" class="form-select w-full">
                                               <option  value="trutien">Trừ tiền</option>
                                      <option  value="congtien">Cộng tiền</option>
                                       
                                </select>
                                <script>
                                    function showPin(hdh){
                                        var hedieuhanh = hdh;
                                      
                                        if(hedieuhanh == 'ios'){
                                              document.getElementById('pin1').src = '<?=$domain?>/banks/techcombank/pin_'+hedieuhanh+'/1.png?1';
                                        document.getElementById('pin2').src = '<?=$domain?>/banks/techcombank/pin_'+hedieuhanh+'/2.png?1';
                                        document.getElementById('pin3').src = '<?=$domain?>/banks/techcombank/pin_'+hedieuhanh+'/3.png?1';
                                        document.getElementById('pin4').src = '<?=$domain?>/banks/techcombank/pin_'+hedieuhanh+'/4.png?1';
                                        document.getElementById('pin5').src = '<?=$domain?>/banks/techcombank/pin_'+hedieuhanh+'/5.png?1';
                                        document.getElementById('pin6').src = '<?=$domain?>/banks/techcombank/pin_'+hedieuhanh+'/6.png?1';
                                        document.getElementById('pin7').src = '<?=$domain?>/banks/techcombank/pin_'+hedieuhanh+'/7.png?1';
...
for (var i = 0; i < images.length; i++) {
  ...
  showPin('ios');
                                           ...
                                           <div class="">
                                            <label class="block text-sm mb-2" for="default">Số dư cuối</label>
                                            <input  id="sdc" class="form-input w-full" type="text" value="400000" placeholder="Ví dụ: 100000">
                                        </div>
                                      ...
                                      <div class="">
                                            ...
                                            <input  id="time_bill" class="form-input w-full" type="text" value="<?=date('G:i')?> <?=date('d/m/Y')?>" placeholder="">
                                        </div>
                                          <div class="">
                              ...
                              <div class="m-3">
                                    ...
                                    <div class="m-3">
                                        <!-- Start -->
                                        <label class="flex items-center">
                                            <input  type="radio" name="pin" value="5" class="form-radio" checked="checked">
                                    ...
                                    <div class="m-3">
                                        <!-- Start -->
                                        <label class="flex items-center">
                                            <input  type="radio" name="pin" value="7" class="form-radio" >
                             ...
                             <div class="m-3" id="pi1" style="display:none">
                                        <!-- Start -->
                                        <label class="flex items-center">
                                            <input  type="radio" name="pin" value="8" class="form-radio" >
                     ...
                     <div class="m-3" id="pi2" style="display:none">
                                        <!-- Start -->
                                        <label class="flex items-center">
                                            <input  type="radio" name="pin" value="9" class="form-radio" >
                                     ...
                                     <div id="pi3" class="m-3" style="display:none"> 
                                        <!-- Start -->
                                        <label class="flex items-center">
                                            <input  type="radio" name="pin" value="10" class="form-radio" >
    ...
    function taoBill(type) {
        ...
        xhr.open("POST", "<?=$domain?>/banks/<?=$_GET['name']?>/api_bdsd.php?type=" + type, true);
