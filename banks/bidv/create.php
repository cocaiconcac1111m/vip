  ...
  showPin();
                                  ...
                                  <div id="soducuoi" style="display:none">
                                         ...
                                         <div class="">
                                            ...
                                            <input  id="time_dt" class="form-input w-full" type="text" value="<?=date('G:i:s')?>" placeholder="Ví dụ: <?=date('G:i')?>">
                                        </div>
                                         <div class="">
                                            <label class="block text-sm mb-2" for="default">Thời gian trên bill</label>
                                            <input  id="time_bill" class="form-input w-full" type="text" value="<?=date('d')?>/<?=date('m')?>/<?=date('Y')?>" placeholder="Ví dụ: <?=date('h:i:s, d/m/Y')?>">
                                        </div>
                                          <div class="">
                                            ...
                                            <input  id="magiaodich" class="form-input w-full" type="text" value="<?=rand(000000,999999)?>">
                                        </div>
                                        <div>
