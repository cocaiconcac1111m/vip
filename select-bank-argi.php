<div class="">
    ...
    <select onchange="" id="bank_nhan" class="form-select w-full">
        ...
        <option value="TMCP Công Thương Việt Nam" int="vietinbank" ant="VietinBank">VietinBank</option>
        ...
        <option value="TNHH MTV Public Việt Nam" int="PBViệt Nam" ant="Public bank">Public bank</option>
        <option value="TNHH MTV Hongleong Việt Nam" int="HLB" ant="Hongleong Bank">Hongleong Bank</option>
