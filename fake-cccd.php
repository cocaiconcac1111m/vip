...
<head>
    ...
    $metatags
        ->title('Fake CCCD')
        ->description('Dịch vụ fake cccd xác thực zalo, unlock fb...')
...
<body
    ...
    <main class="grow">
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            <div class="px-4 py-8">
                <div class="">
                    <h1 class="text-3xl text-slate-800 dark:text-slate-100 font-bold mb-6">Fake CCCD tự động, nhận ngay sau 30s
                    </h1>
                    <?php include 'cccd/index.php'; ?>
                </div>
            </div>
