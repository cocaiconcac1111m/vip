...
$metatags
        ->title('Fake biến động số dư ngân hàng '.$user['name'])
...
<?php include('files/header.php');?>
     ...
     <div class="px-4 py-8">
                        <div class="">
                            ...
                            <h1 class="text-3xl text-slate-800 dark:text-slate-100 font-bold mb-6">Fake biến động số dư ngân hàng <?=$user['name']?></h1>
                        <?php include 'banks/'.$user['file_name'].'/bdsd.php'; ?>
