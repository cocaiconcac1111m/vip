<div class="">
  <label class="block text-sm mb-2" for="default">Ngân hàng nhận</label>
  <select onchange="" id="bank_nhan" class="form-select w-full">
    <option value="TMCP Ngoại Thương" int="VCB" ant="VietcomBank">VietcomBank</option>
    <option value="TMCP Công Thương" int="CTG" ant="VietinBank">VietinBank</option>
    <option value="TMCP Kỹ Thương" int="TCB" ant="Techcombank">Techcombank</option>
    ...
    <option value="TNHH MTV Shinhan" int="SVB" ant="Shinhan Bank">Shinhan Bank</option>
    <option value="TMCP Quốc Tế" int="VIB" ant="VIB Bank">VIB Bank</option>
    ...
    <option value="TMCP Xuất Nhập Khẩu" int="EIB" ant="Eximbank">Eximbank</option>
    ...
    <option value="TMCP Đại Chúng" int="PVCB" ant="PVCombank">PVCombank</option>
    ...
    <option value="TNHH MTV Public" int="PBVN" ant="Public bank">Public bank</option>
    <option value="TNHH MTV Hongleong" int="HLB" ant="Hongleong Bank">Hongleong Bank</option>
    ...
    <option value="TNHH MTV CIMB" int="CIMB" ant="CIMB">CIMB</option>
    ...
    <option value="TMCP Hàng Hải" int="MSB" ant="Maritime Bank">Maritime Bank</option>
    ...
    <option value="TNHH MTV HSBC" int="HSBC" ant="HSBC">HSBC</option>
