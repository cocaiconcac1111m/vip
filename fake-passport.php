...
<head>
    ...
    $metatags
        ->title('Fake hộ chiếu')
        ->description('Dịch vụ fake hộ chiếu')
...
<body
    ...
    <main class="grow">
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            <div class="px-4 py-8">
                <div class="">
                    <h1 class="text-3xl text-slate-800 dark:text-slate-100 font-bold mb-6">Fake passport hộ chiếu tự động, nhận ngay sau 30s
                    </h1>
                    <?php include 'passport/index.php'; ?>
                </div>
            </div>
        </div>
    </main>
